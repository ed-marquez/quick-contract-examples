...
async function main() {
	...
	const nft2Send = new NftId(tokenId, 1);

	const allowanceTx = new AccountAllowanceApproveTransaction()
		.approveTokenNftAllowance(nft2Send, treasuryId, aliceId)
		// .approveTokenNftAllowanceAllSerials(tokenId, treasuryId, aliceId) // Can approve all serials under a NFT collection
		.freezeWith(client);
